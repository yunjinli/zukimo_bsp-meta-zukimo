DESCRIPTION = "DCT IPC GPIO Driver"
SECTION = "dct"
...
SRCREV = "${ZUK_REPO_SRCREV_IPC_GPIO}"
SRC_URI = "${ZUK_REPO_URLBASE}/${ZUK_REPO_NAME_IPC_GPIO};protocol=${ZUK_REPO_PROTOCOL};branch=${ZUK_REPO_BRANCH_IPC_GPIO}"
S = "${WORKDIR}/git/linux"

EXTRA_OEMAKE += "O=${STAGING_KERNEL_BUILDDIR} EXTRA_INC=-I${STAGING_KERNEL_BUILDDIR}/include/dct"

RPROVIDES:${PN} += "kernel-module-dct-ipc-gpio"

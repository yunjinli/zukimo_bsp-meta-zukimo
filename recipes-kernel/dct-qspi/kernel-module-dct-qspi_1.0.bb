...
SRCREV = "${ZUK_REPO_SRCREV_QSPI}"
SRC_URI = "${ZUK_REPO_URLBASE}/${ZUK_REPO_NAME_QSPI};protocol=${ZUK_REPO_PROTOCOL};branch=${ZUK_REPO_BRANCH_QSPI}"
S = "${WORKDIR}/git/linux"

EXTRA_OEMAKE += "O=${STAGING_KERNEL_BUILDDIR} EXTRA_INC=-I${STAGING_KERNEL_BUILDDIR}/include/dct"

RPROVIDES:${PN} += "kernel-module-dct-qspi"
